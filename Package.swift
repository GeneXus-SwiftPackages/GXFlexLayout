...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/preview/GXFlexLayout-1.4.0-rc.5.xcframework.zip",
			checksum: "58d521d4fccf506cd751ebcd7fd84a48380b1c4d8fbe9722455c8750ee9381ba"
		)
	]
)