...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.2.0-beta.37.xcframework.zip",
			checksum: "9e3cb09868d5d2609fe30bea8dfba8ab5465178a63c152ee94ad79abd462a878"
		)
	]
)