...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-2.0.0-beta.23.xcframework.zip",
			checksum: "ee43b4875e4f3d1ee249f8a4de53eef5486817e8a52c57e6af1ef9895ed2634a"
		)
	]
)