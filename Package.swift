...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.5.0-beta.18.xcframework.zip",
			checksum: "1201da2c702b7ddbcee8ad1d17482dad50bec2ef92e97bce265b166652d4f992"
		)
	]
)