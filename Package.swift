...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/preview/GXFlexLayout-2.0.0-rc.32.xcframework.zip",
			checksum: "756a212856bf376ee163e2bfdfb4b23d4e36713fe4326ba043e6644c0a72424f"
		)
	]
)