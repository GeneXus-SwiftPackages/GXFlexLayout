...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.2.0-beta.21.xcframework.zip",
			checksum: "ede57c16e8bfbaeeabda12e170448ce0c7f6d6e0f9ba64bb35d523a196718f69"
		)
	]
)