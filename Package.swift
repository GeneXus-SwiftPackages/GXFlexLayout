...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.1.0-beta.5.xcframework.zip",
			checksum: "507fec9a16e5ee396554c9bbef7d023227d4ac2ba4539c56a99dd41293e146d6"
		)
	]
)