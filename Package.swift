...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/preview/GXFlexLayout-2.1.0-rc.25.xcframework.zip",
			checksum: "8d77dddc24e39eeadd8c0971ceced94cf95dbd913b9c33313d0a0e080ee3a5d4"
		)
	]
)