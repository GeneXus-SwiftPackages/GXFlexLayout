...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/preview/GXFlexLayout-3.2.0-rc.0.xcframework.zip",
			checksum: "e4f06fc234071351345c76e8d30338a31a05d3fc714f1fe18f49b031b41f5c6b"
		)
	]
)