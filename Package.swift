...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.0.0-beta.20230707153504.xcframework.zip",
			checksum: "b9507f23448b8d805f7ff28a26dcee2566c90f02a313a78d698cad29edaaaf6c"
		)
	]
)