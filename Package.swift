...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.1.0-beta.12.xcframework.zip",
			checksum: "f187203a7a548517fc1a7a2c19ceb60240ccffd0be0261f356de58a69424678f"
		)
	]
)