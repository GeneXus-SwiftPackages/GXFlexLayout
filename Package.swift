...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.1.0-beta.795.xcframework.zip",
			checksum: "e08f539b522bec896270057991c5409328e40f94b412f68492df253a04f51e9b"
		)
	]
)