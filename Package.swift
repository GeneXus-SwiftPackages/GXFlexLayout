...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/preview/GXFlexLayout-1.1.0-rc.5.xcframework.zip",
			checksum: "4f70244e46b5ce15ee57dc9799fdba3b73d1769f9568d6492f51e0b8c7df3324"
		)
	]
)