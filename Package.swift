...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.5.0-beta.3.xcframework.zip",
			checksum: "2eca3cc2650b4628afb3f8c83698c942f7110a3107e533d5ba2d5e62d30916cf"
		)
	]
)