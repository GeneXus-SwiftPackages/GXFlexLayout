...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.3.0-beta.3.xcframework.zip",
			checksum: "efec231c95729b83bdfbb1897e0adf29388d85294f5f24372db9d6559648b52e"
		)
	]
)