...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.4.0-beta.12.xcframework.zip",
			checksum: "0e27d1ed7bc73f92c212a671cc36e728bb051f89237c6008790504fa02158d56"
		)
	]
)