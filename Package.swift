...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.5.0-beta.13.xcframework.zip",
			checksum: "84af3540eca8ad6fafb1a09710a25d9227e7823a4a364b62156600775585efb8"
		)
	]
)