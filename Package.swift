...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.3.0-beta.8.xcframework.zip",
			checksum: "f4e37849b651d348c59b102febcd4ce9ae2278deb126bb7f39e150f180a09a23"
		)
	]
)