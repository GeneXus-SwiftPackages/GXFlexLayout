...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.5.0-beta.28.xcframework.zip",
			checksum: "14586d8a56a96160d367d01b195a1a19aae80989ea36f3dec4a5c93ea461053f"
		)
	]
)