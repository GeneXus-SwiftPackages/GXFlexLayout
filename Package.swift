...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.6.0-beta.1.xcframework.zip",
			checksum: "393a6e63de78804c2f9132d160928f600148ea23052ab66d6cfabac7fa3ed736"
		)
	]
)