...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-3.1.0-beta.2.xcframework.zip",
			checksum: "bc01578e804f8c6bd647bd55d9874c748942d84078a3db50ca8f59619ce7c5aa"
		)
	]
)