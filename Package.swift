...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/preview/GXFlexLayout-1.2.0-rc.29.xcframework.zip",
			checksum: "db7edf0d079f62e9dd1ce30ae8cc3ad088839a16cd27add89073d3ab09522e6e"
		)
	]
)