...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.0.0-beta.20230623154354.xcframework.zip",
			checksum: "8d1906e10b7fdd8cd62d7bcd52bca56f3fdb993044f3b1c6d78464eb93f3527a"
		)
	]
)