...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-2.1.0-beta.25.xcframework.zip",
			checksum: "c5e2bf2d858988334a0ca2b2b09debf7d143ef33423e778502e52932ed164d94"
		)
	]
)