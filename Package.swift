...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.2.0-beta.31.xcframework.zip",
			checksum: "712bcc3a4b876ee7bb3231e3b5647638ac62787cfa86e1233d6b01ce17eadee9"
		)
	]
)