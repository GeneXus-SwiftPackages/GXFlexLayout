...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.5.0-beta.20.xcframework.zip",
			checksum: "cc556f48b36d89516e1c887f9fc7b227210597605e67e45efaf1bdb628dd7cef"
		)
	]
)