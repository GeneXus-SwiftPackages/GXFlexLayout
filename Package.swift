...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.5.0-beta.25.xcframework.zip",
			checksum: "6fb8959249ac87d08342ac58dce060d83358e8c6c4da1a6602a78f6430808e57"
		)
	]
)