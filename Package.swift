...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/releases/GXFlexLayout-1.1.0-rc.1.xcframework.zip",
			checksum: "5728f039473daaf77aa69ba600472e155a5758e9b7160437b2a1c0dafaf0b490"
		)
	]
)