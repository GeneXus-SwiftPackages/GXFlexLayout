...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.1.0-beta.7.xcframework.zip",
			checksum: "9359470ed8dc5fa25224deb2e25ac23fc7b4499bc8e074f091272d33816446d1"
		)
	]
)