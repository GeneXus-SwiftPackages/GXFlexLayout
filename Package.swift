...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.5.0-beta.12.xcframework.zip",
			checksum: "35e00d78ad59299dc223c59e1533e71f7892608a74632969e07fe14b8ed01283"
		)
	]
)