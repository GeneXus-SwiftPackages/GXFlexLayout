...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.4.0-beta.8.xcframework.zip",
			checksum: "bb91727d051aa706d5770b8cd6dd846b43e802fa9654adfc9dac1481348baf96"
		)
	]
)