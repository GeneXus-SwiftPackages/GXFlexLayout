...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/preview/GXFlexLayout-1.3.0-rc.7.xcframework.zip",
			checksum: "4de759d697fe4bcf0f7e6aeb711a42c34e9ba67c59f1287642d75c0a84c3f93c"
		)
	]
)