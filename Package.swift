...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.2.0-beta.19.xcframework.zip",
			checksum: "ecaccf8d1c47f6bac331719eaebd8be94adf5a6ddb8e7c0eb90a8b91c7a195f7"
		)
	]
)