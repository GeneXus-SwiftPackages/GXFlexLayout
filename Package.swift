...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.2.0-beta.27.xcframework.zip",
			checksum: "dd22b77cdf8b76d8715f4c1ecc47599c72368a49f1b3499bb9787c8302aa9d57"
		)
	]
)