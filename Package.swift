...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.5.0-beta.11.xcframework.zip",
			checksum: "133082a290e2d06f1d1710e4102bbddd9b77fbbd653f5924f11a10be8cfe4865"
		)
	]
)