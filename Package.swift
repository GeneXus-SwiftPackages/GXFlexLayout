...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.1.0-beta.6.xcframework.zip",
			checksum: "d261ff670e00aacc428584ee7dcd5a3b3f8c6697670f2bf4cffa5f3d640c005d"
		)
	]
)