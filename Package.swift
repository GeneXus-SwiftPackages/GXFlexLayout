...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.3.0-beta.9.xcframework.zip",
			checksum: "0e4db953ab5cfe4fd5de477c37bd857fbc145caaa80891285b14dca1f7deefab"
		)
	]
)