...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/preview/GXFlexLayout-1.5.0-rc.28.xcframework.zip",
			checksum: "0ad2f9340d867194b59cd51115dcee09ea59cf905a4f220d85ac422045c6346c"
		)
	]
)