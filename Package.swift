...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/preview/GXFlexLayout-4.0.0-rc.43.xcframework.zip",
			checksum: "789b88ffc7412c8348811f06834d400accbc68a0370459b1d675fc9affe7851a"
		)
	]
)