...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.3.0-beta.7.xcframework.zip",
			checksum: "9dff7bbff3e11ad01f33f2147e24194ae7c9c16b0d2d6c83c5287aabef32313b"
		)
	]
)