...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-2.1.0-beta.23.xcframework.zip",
			checksum: "0d60584f5ed30a4c3182c1979f0f22115d8474ba688cb84e4de55f7a5dda8d10"
		)
	]
)