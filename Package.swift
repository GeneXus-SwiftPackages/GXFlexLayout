...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.4.0-beta.13.xcframework.zip",
			checksum: "a832e93e888db7878822ac00fdfb09fe4152df4f0865eb1d4fd32357ca78ccf6"
		)
	]
)