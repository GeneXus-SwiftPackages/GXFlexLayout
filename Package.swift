...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-3.2.0-beta.20.xcframework.zip",
			checksum: "c7ea26368bf9a74840ac9de0c13bae92b8fc5da83271a75e6a1b2e53e1ab1cdc"
		)
	]
)