...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.3.0-beta.4.xcframework.zip",
			checksum: "d2e9b529b5505322e3de4bd8b0de8457a8a36d0846b54d8fea199c50df9ab178"
		)
	]
)