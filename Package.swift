...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.1.0-beta.10.xcframework.zip",
			checksum: "9cd6677185ebd16b58cbd3e86ca04761e73ca8101c0ba0a529f4ce8632f2e947"
		)
	]
)