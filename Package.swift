...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-2.0.0-beta.6.xcframework.zip",
			checksum: "d31c7dc808fa08e2bee4356a2f169b27b1ca3a966b8caec9413936c13792cfee"
		)
	]
)