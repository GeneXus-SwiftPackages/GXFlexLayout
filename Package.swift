...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.5.0-beta.24.xcframework.zip",
			checksum: "a91170731ec4d66afea26e446a666ab0243805c684e322e285ed189e6e700fdc"
		)
	]
)