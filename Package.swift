...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.5.0-beta.5.xcframework.zip",
			checksum: "68186718cc1b81606baca5285a959a69ece78c73e41bbc84b4c456533ac82f58"
		)
	]
)