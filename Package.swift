...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.2.0-beta.1.xcframework.zip",
			checksum: "58de41cc43a861f6919a5e2509f4c542320b2e8f6ededfd7fadd41f5f7670cb1"
		)
	]
)