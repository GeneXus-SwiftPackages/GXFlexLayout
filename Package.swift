...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.2.0-beta.29.xcframework.zip",
			checksum: "22b3e0746237dc842ff2e5ab9df244b6fa4fa10a4e138e896370fdcfd44dc1a9"
		)
	]
)