...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.4.0-beta.7.xcframework.zip",
			checksum: "b2d3cdb7bc37fc7a5355d584d958cee0ff0477f80a24293fc1323ebbd76a7b7d"
		)
	]
)