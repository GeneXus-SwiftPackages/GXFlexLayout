...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/preview/GXFlexLayout-2.1.0-rc.23.xcframework.zip",
			checksum: "0478cef538932007687fc5263ed11bac033d5c3ba68aca7e074c72dfe8ad6d50"
		)
	]
)