...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.2.0-beta.24.xcframework.zip",
			checksum: "2fa816514ac84fac3322efc5a235015982c338b9b7a6c387ee5455bced8afbc8"
		)
	]
)