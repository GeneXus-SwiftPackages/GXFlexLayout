...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.5.0-beta.19.xcframework.zip",
			checksum: "8d88027e5d354dd931ccb106b92c6d8e1b2a523565c5e867301d6440d3c90d1c"
		)
	]
)