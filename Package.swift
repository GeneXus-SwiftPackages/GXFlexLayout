...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.1.0-beta.9.xcframework.zip",
			checksum: "0a8067353caeb7b1b1f8ba831e94e71e2d4afa635737c4478192da7749796d48"
		)
	]
)