...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.5.0-beta.16.xcframework.zip",
			checksum: "bc754ed442c93804ed36a7eb8bed2cb42540eb78597e36118ff32ff6f665d579"
		)
	]
)