...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.4.0-beta.11.xcframework.zip",
			checksum: "84ab5bbec85753371a8905b09e1a0c109354c9c681457c98ad845c87c862f314"
		)
	]
)