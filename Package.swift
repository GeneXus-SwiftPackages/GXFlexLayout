...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.6.0-beta.4.xcframework.zip",
			checksum: "06c5221bc4d2621ed198c82e66f2be591652b22b0d5ad4a8933cbc4ec91ac5f5"
		)
	]
)