...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-3.2.0-beta.38.xcframework.zip",
			checksum: "04e945585aac70c666f99f9c4fc323dc799ce048b38fdc233dd7f9607f909a84"
		)
	]
)