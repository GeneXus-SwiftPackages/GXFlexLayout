...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/preview/GXFlexLayout-1.4.0-rc.10.xcframework.zip",
			checksum: "88f78ed55a2b8d679b49b33152a3a6e21a84288c2d1d4f0219ffcfbfb738e379"
		)
	]
)