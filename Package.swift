...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-2.0.0-beta.36.xcframework.zip",
			checksum: "83673dab129d98da41cd1cf4240f496f29495821ae3a87244f16bfdc7643452c"
		)
	]
)