...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.2.0-beta.17.xcframework.zip",
			checksum: "f16d70efe55719338e57f1287b68836e9e3d6b748bbb1667a64de3ec5815b9c4"
		)
	]
)