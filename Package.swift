...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-2.0.0-beta.7.xcframework.zip",
			checksum: "a892d6ca37978b909aefc830a2d8c949813d348f961972fef5b417d58cb402b4"
		)
	]
)