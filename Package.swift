...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/preview/GXFlexLayout-1.4.0-rc.1.xcframework.zip",
			checksum: "e83c0574b8112aa1f503919010d94cf6d7eaef35ce680d86acfab4a53ad9e350"
		)
	]
)