...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-1.1.0-beta.8.xcframework.zip",
			checksum: "0fa3e6138d3f89f28e4efa37eba2fcb3002dbb027e81dc11eee47f35bd34216c"
		)
	]
)