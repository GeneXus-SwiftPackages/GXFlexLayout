...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-2.0.0-beta.28.xcframework.zip",
			checksum: "d8b2317344f9dc46dfe801e59bef6a1bae400dbaf7f365318fe1d3b540f7b745"
		)
	]
)