...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/preview/GXFlexLayout-1.6.0-rc.0.xcframework.zip",
			checksum: "bca0edca9982bf2421cb21d0f06dd99bbd0ec561da3c9dbb3d841e96e5570483"
		)
	]
)