...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFlexLayout",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFlexLayout-2.0.0-beta.29.xcframework.zip",
			checksum: "60074c33a232b956f718185d6e1c112e974b9651882f23b6716f358b1bfa5adf"
		)
	]
)